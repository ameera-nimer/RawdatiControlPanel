  ...
  <div class="container-scroller">
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" ><img src="{{asset('images/logo_rawdati.svg')}}" class="mr-2" alt="logo"/></a>
...
<!--                 <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li>
 -->              </ul>
          ...
          <li class="nav-item {{( $activePage == 'student' || $activePage == 'student_details' || $activePage =='student_create' || $activePage =='student_edit')?' active' : '' }}">
          ...
          <li class="nav-item {{($activePage == 'section' || $activePage == 'section_details' || $activePage =='section_create' || $activePage =='section_edit')?' active' : '' }}" >
